...
//                    .build();
                    .apis(RequestHandlerSelectors.basePackage("cn.hgxsp.hegangxsp.controller"))
                    .paths(PathSelectors.any()).build();
        }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("鹤岗小商品api接口文档")
                // 设置联系人
                .contact(new Contact("侯立男", "http://www.hgxsp.cn", "houlinan@vip.qq.com"))
                // 描述
                .description("欢迎访问鹤岗小商品接口文档，这里是描述信息")
                // 定义版本号
                .version("1.0").build();
    }
